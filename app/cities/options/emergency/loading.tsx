  ...
  return (
    <main className="max-w-screen-lg mx-auto my-8 p-4 animate-pulse">
      ...
      <div className="grid gap-6">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="border border-gray-700 rounded-xl bg-gray-800/30 flex flex-col md:flex-row justify-between p-6 gap-4">
            <div className="flex-1 space-y-4">
              <div className="h-8 w-1/2 bg-gray-700 rounded" />
              <div className="h-4 w-full bg-gray-700 rounded" />
              <div className="h-6 w-1/3 bg-gray-700 rounded" />
            </div>
            <div className="h-14 w-full md:w-40 bg-gray-700 rounded-lg" />
          </div>
        ))}
      </div>
    </main>
